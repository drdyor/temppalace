...
- **Grammar tagging**: B1 exchanges annotated with `grammarTags: [{text, type}]`. Types: `passato_prossimo`, `futuro`, `congiuntivo`, `imperfetto`, `condizionale`, `imperativo`. Tagged phrases highlighted inline in the dialogue panel.
...
## New Since Last Handover (2026-04-19)

### Zone Dialogues — A2 + B1

`src/data/zone-stories.ts` — 51 zones × 2 levels (A2 + B1) = 102 dialogue entries.
...
B1 dialogues generated by qwen3:14b, judged by Minerva-7B (avg score 4.06/5). A2 dialogues from DeepSeek + qwen3:14b.
