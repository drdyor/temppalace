...
import { ArrowRight, Brain, BookOpen, Map } from 'lucide-react';
    ...
    <div className="min-h-screen bg-palace-bg">
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className="relative text-center max-w-2xl mx-auto">
          <h1 className="font-cinzel text-5xl md:text-7xl text-palace-text mb-6">
            Memory Palace
          </h1>
          <p className="text-palace-gold text-xl md:text-2xl font-cinzel mb-4">
            Learn Languages Through Space
          </p>
          <p className="text-palace-text/70 text-lg mb-8 max-w-lg mx-auto">
            Master Italian vocabulary by exploring a virtual palace. 
            Each room teaches new words through spatial memory and stories.
          </p>
      ...
      <div className="py-20 px-4">
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
          <FeatureCard
            ...
            description="Words are tied to locations. Your brain remembers where things are."
          />
          <FeatureCard
            icon={<BookOpen className="w-8 h-8" />}
            title="9 Stories Per Room"
            description="Past, present, and future narratives embed vocabulary in context."
          />
          <FeatureCard
            icon={<Brain className="w-8 h-8" />}
            title="Spaced Repetition"
            description="Practice and test modes with intelligent review scheduling."
          />
        </div>
      </div>
    </div>
