...
export const rooms: Room[] = [
  {
    ...
    vocabularyIds: ["madre", "padre", "fratello", "sorella", "nonno", "nonna", "zio", "zia", "figlio", "figlia", "cappotto", "giacca", "impermeabile", "sciarpa", "cappello", "guanto", "cravatta", "cintura", "borsa", "maglione", "bello", "brutto", "giovane", "vecchio", "alto", "basso", "magro", "grasso", "forte", "debole", "secondo", "minuto", "ora", "giorno", "notte", "mattina", "sera", "mezzogiorno", "mezzanotte", "tempo", "uno", "due", "tre", "quattro", "cinque", "sei", "sette", "otto", "nove", "dieci", "undici", "dodici", "ciao", "buongiorno", "buonasera", "buonanotte", "grazie", "prego", "scusa", "arrivederci", "permesso", "forse"],
    zones: [
      { id: 'family-portrait', name: 'Family Portrait', nameNative: "Ritratto di Famiglia", description: 'Family members on the wall', icon: '👨‍👩‍👧‍👦', x: 30, y: 40, width: 20, height: 25, interiorImage: '/rooms/entrance-portrait.jpg', interiorVocab: [{ wordId: 'madre', x: 13, y: 17 }, { wordId: 'padre', x: 38, y: 17 }, { wordId: 'fratello', x: 63, y: 17 }, { wordId: 'sorella', x: 88, y: 17 }, { wordId: 'nonno', x: 13, y: 50 }, { wordId: 'nonna', x: 38, y: 50 }, { wordId: 'zio', x: 63, y: 50 }, { wordId: 'zia', x: 88, y: 50 }, { wordId: 'figlio', x: 13, y: 83 }, { wordId: 'figlia', x: 38, y: 83 }] },
      ...
      { id: 'mirror', name: 'The Mirror', nameNative: "Lo Specchio", description: 'Body parts and descriptions', icon: '🪞', x: 50, y: 35, width: 15, height: 20, interiorVocab: [{ wordId: 'bello', x: 13, y: 17 }, { wordId: 'brutto', x: 38, y: 17 }, { wordId: 'giovane', x: 63, y: 17 }, { wordId: 'vecchio', x: 88, y: 17 }, { wordId: 'alto', x: 13, y: 50 }, { wordId: 'basso', x: 38, y: 50 }, { wordId: 'magro', x: 63, y: 50 }, { wordId: 'grasso', x: 88, y: 50 }, { wordId: 'forte', x: 13, y: 83 }, { wordId: 'debole', x: 38, y: 83 }] },
      { id: 'clock', name: 'The Clock', nameNative: "L'Orologio", description: 'Days, months, and time', icon: '🕰️', x: 15, y: 25, width: 12, height: 12, interiorVocab: [{ wordId: 'secondo', x: 13, y: 17 }, { wordId: 'minuto', x: 38, y: 17 }, { wordId: 'ora', x: 63, y: 17 }, { wordId: 'giorno', x: 88, y: 17 }, { wordId: 'notte', x: 13, y: 50 }, { wordId: 'mattina', x: 38, y: 50 }, { wordId: 'sera', x: 63, y: 50 }, { wordId: 'mezzogiorno', x: 88, y: 50 }, { wordId: 'mezzanotte', x: 13, y: 83 }, { wordId: 'tempo', x: 38, y: 83 }] },
      { id: 'number-plate', name: 'House Number', nameNative: "Il Numero Civico", description: 'Numbers and quantities', icon: '🔢', x: 85, y: 25, width: 10, height: 10, interiorVocab: [{ wordId: 'uno', x: 13, y: 17 }, { wordId: 'due', x: 38, y: 17 }, { wordId: 'tre', x: 63, y: 17 }, { wordId: 'quattro', x: 88, y: 17 }, { wordId: 'cinque', x: 13, y: 50 }, { wordId: 'sei', x: 38, y: 50 }, { wordId: 'sette', x: 63, y: 50 }, { wordId: 'otto', x: 88, y: 50 }, { wordId: 'nove', x: 13, y: 83 }, { wordId: 'dieci', x: 38, y: 83 }, { wordId: 'undici', x: 63, y: 83 }, { wordId: 'dodici', x: 88, y: 83 }] },
      { id: 'welcome-mat', name: 'Welcome Mat', nameNative: "Zerbino", description: 'Common words and questions', icon: '🚪', x: 45, y: 80, width: 25, height: 12, interiorVocab: [{ wordId: 'ciao', x: 13, y: 17 }, { wordId: 'buongiorno', x: 38, y: 17 }, { wordId: 'buonasera', x: 63, y: 17 }, { wordId: 'buonanotte', x: 88, y: 17 }, { wordId: 'grazie', x: 13, y: 50 }, { wordId: 'prego', x: 38, y: 50 }, { wordId: 'scusa', x: 63, y: 50 }, { wordId: 'arrivederci', x: 88, y: 50 }, { wordId: 'permesso', x: 13, y: 83 }, { wordId: 'forse', x: 38, y: 83 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    zones: [
      ...
      { id: 'fridge', name: 'The Fridge', nameNative: "Il Frigorifero", description: 'Cold food and drinks - dairy, meat, vegetables, fruits', icon: '❄️', x: 75, y: 45, width: 15, height: 25, interiorImage: '/rooms/kitchen-fridge.jpg', interiorVocab: [{ wordId: 'acqua', x: 15, y: 15 }, { wordId: 'latte', x: 35, y: 15 }, { wordId: 'uova', x: 55, y: 15 }, { wordId: 'burro', x: 75, y: 15 }, { wordId: 'formaggio', x: 85, y: 15 }, { wordId: 'carne', x: 15, y: 40 }, { wordId: 'pesce', x: 35, y: 40 }, { wordId: 'pollo', x: 55, y: 40 }, { wordId: 'mela', x: 75, y: 40 }, { wordId: 'arancia', x: 85, y: 40 }, { wordId: 'pomodoro', x: 15, y: 65 }, { wordId: 'carota', x: 35, y: 65 }, { wordId: 'insalata', x: 55, y: 65 }] },
      // PANTRY - Dry goods (pasta, rice, bread, flour, sugar, coffee, oil, preserves)
      { id: 'pantry', name: 'The Pantry', nameNative: "La Dispensa", description: 'Dry goods and staples - pasta, rice, canned goods', icon: '🥫', x: 88, y: 40, width: 10, height: 30, interiorImage: '/rooms/kitchen-pantry.jpg', interiorVocab: [{ wordId: 'pasta', x: 15, y: 15 }, { wordId: 'riso', x: 35, y: 15 }, { wordId: 'pane', x: 55, y: 15 }, { wordId: 'farina', x: 75, y: 15 }, { wordId: 'zucchero', x: 85, y: 15 }, { wordId: 'sale', x: 15, y: 40 }, { wordId: 'olio', x: 35, y: 40 }, { wordId: 'caffe', x: 55, y: 40 }, { wordId: 'cioccolata', x: 75, y: 40 }, { wordId: 'miele', x: 85, y: 40 }, { wordId: 'biscotto', x: 15, y: 65 }, { wordId: 'conserva', x: 35, y: 65 }] },
      // UTENSIL DRAWER - Kitchen tools (knives, forks, spoons, grater, scissors)
      { id: 'utensil-drawer', name: 'Utensil Drawer', nameNative: "Il Cassetto delle Posate", description: 'Knives, forks, spoons and kitchen tools', icon: '🍴', x: 50, y: 70, width: 15, height: 12, interiorImage: '/rooms/kitchen-drawer.jpg', interiorVocab: [{ wordId: 'coltello', x: 20, y: 25 }, { wordId: 'forchetta', x: 40, y: 25 }, { wordId: 'cucchiaio', x: 60, y: 25 }, { wordId: 'mestolo', x: 80, y: 25 }, { wordId: 'spatola', x: 20, y: 50 }, { wordId: 'grattugia', x: 40, y: 50 }] },
      // STOVE - Cooking area (pan, pot, cutting board, oven, stove)
      { id: 'stove', name: 'The Stove', nameNative: "I Fornelli", description: 'Cooking and preparation - pots, pans, oven', icon: '🔥', x: 60, y: 55, width: 15, height: 15, interiorImage: '/rooms/kitchen-stove.jpg', interiorVocab: [{ wordId: 'padella', x: 20, y: 25 }, { wordId: 'pentola', x: 50, y: 25 }, { wordId: 'tagliere', x: 80, y: 25 }, { wordId: 'forno', x: 20, y: 55 }, { wordId: 'fornello', x: 50, y: 55 }, { wordId: 'colino', x: 80, y: 55 }] },
      // TABLE - Dining (plates, glasses, cups, napkins, wine, beer, juice)
      { id: 'table', name: 'The Table', nameNative: "Il Tavolo", description: 'Dining and eating - plates, glasses, meals', icon: '🍽️', x: 25, y: 65, width: 20, height: 15, interiorImage: '/rooms/kitchen-table.jpg', interiorVocab: [{ wordId: 'piatto', x: 15, y: 25 }, { wordId: 'bicchiere', x: 35, y: 25 }, { wordId: 'tazza', x: 55, y: 25 }, { wordId: 'tovagliolo', x: 75, y: 25 }, { wordId: 'caraffa', x: 85, y: 25 }, { wordId: 'vino', x: 15, y: 55 }, { wordId: 'birra', x: 35, y: 55 }, { wordId: 'succo', x: 55, y: 55 }, { wordId: 'colazione', x: 75, y: 55 }, { wordId: 'pranzo', x: 85, y: 55 }, { wordId: 'cena', x: 50, y: 80 }] },
      // DESSERT - Sweets (cake, gelato, croissant, chocolate, honey, cookies)
      { id: 'dessert', name: 'Dessert Station', nameNative: "I Dolci", description: 'Cakes, gelato, and sweet treats', icon: '🍰', x: 15, y: 50, width: 12, height: 15, interiorImage: '/rooms/kitchen-dessert.jpg', interiorVocab: [{ wordId: 'torta', x: 25, y: 30 }, { wordId: 'gelato', x: 50, y: 30 }, { wordId: 'cornetto', x: 75, y: 30 }, { wordId: 'cioccolata', x: 25, y: 60 }, { wordId: 'miele', x: 50, y: 60 }, { wordId: 'biscotto', x: 75, y: 60 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    vocabularyIds: ["libro", "romanzo", "poesia", "dizionario", "rivista", "giornale", "manuale", "racconto", "biografia", "biblioteca", "quaderno", "penna", "matita", "gomma", "righello", "calendario", "carta", "scrivania", "lezione", "pagina", "schermo", "tastiera", "mouse", "stampante", "password", "file", "computer", "studente", "studentessa", "scienza"],
    zones: [
      { id: 'bookshelf', name: 'The Bookshelf', nameNative: "Lo Scaffale", description: 'School and books', icon: '📚', x: 30, y: 35, width: 25, height: 30, interiorVocab: [{ wordId: 'libro', x: 13, y: 17 }, { wordId: 'romanzo', x: 38, y: 17 }, { wordId: 'poesia', x: 63, y: 17 }, { wordId: 'dizionario', x: 88, y: 17 }, { wordId: 'rivista', x: 13, y: 50 }, { wordId: 'giornale', x: 38, y: 50 }, { wordId: 'manuale', x: 63, y: 50 }, { wordId: 'racconto', x: 88, y: 50 }, { wordId: 'biografia', x: 13, y: 83 }, { wordId: 'biblioteca', x: 38, y: 83 }] },
      { id: 'desk', name: 'Study Desk', nameNative: "La Scrivania", description: 'Study and work', icon: '📝', x: 60, y: 60, width: 20, height: 20, interiorVocab: [{ wordId: 'quaderno', x: 13, y: 17 }, { wordId: 'penna', x: 38, y: 17 }, { wordId: 'matita', x: 63, y: 17 }, { wordId: 'gomma', x: 88, y: 17 }, { wordId: 'righello', x: 13, y: 50 }, { wordId: 'calendario', x: 38, y: 50 }, { wordId: 'carta', x: 63, y: 50 }, { wordId: 'scrivania', x: 88, y: 50 }, { wordId: 'lezione', x: 13, y: 83 }, { wordId: 'pagina', x: 38, y: 83 }] },
      { id: 'computer', name: 'Computer Station', nameNative: "Il Computer", description: 'Technology and time', icon: '💻', x: 85, y: 45, width: 12, height: 15, interiorVocab: [{ wordId: 'schermo', x: 13, y: 17 }, { wordId: 'tastiera', x: 38, y: 17 }, { wordId: 'mouse', x: 63, y: 17 }, { wordId: 'stampante', x: 88, y: 17 }, { wordId: 'password', x: 13, y: 50 }, { wordId: 'file', x: 38, y: 50 }, { wordId: 'computer', x: 63, y: 50 }, { wordId: 'studente', x: 88, y: 50 }, { wordId: 'studentessa', x: 13, y: 83 }, { wordId: 'scienza', x: 38, y: 83 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    vocabularyIds: ["camicia", "maglietta", "giacca", "vestito", "gonna", "pantaloni", "jeans", "pigiama", "maglione", "cappotto", "calze", "orologio", "occhiali", "cintura", "cravatta", "sciarpa", "guanto", "borsa", "collana", "anello", "bracciale", "orecchini", "scarpa", "stivale", "sandali", "pantofole", "scarpette", "letto", "cuscino", "coperta", "lenzuolo", "materasso", "sveglia", "lampada", "libro"],
    zones: [
      ...
      { id: 'drawer', name: 'Accessory Drawer', nameNative: "Il Cassetto", description: 'Socks, ties, belts, scarves, gloves', icon: '🧦', x: 85, y: 60, width: 12, height: 15, interiorImage: '/rooms/bedroom-drawer.jpg', interiorVocab: [{ wordId: 'calze', x: 17, y: 17 }, { wordId: 'orologio', x: 50, y: 17 }, { wordId: 'occhiali', x: 83, y: 17 }, { wordId: 'cintura', x: 17, y: 50 }, { wordId: 'cravatta', x: 50, y: 50 }, { wordId: 'sciarpa', x: 83, y: 50 }, { wordId: 'guanto', x: 17, y: 83 }, { wordId: 'borsa', x: 50, y: 83 }] },
  ...
  },
  {
    ...
    vocabularyIds: ["sapone", "dentifricio", "spazzolino", "asciugamano", "specchio", "rubinetto", "doccia", "shampoo", "bagnoschiuma", "acqua", "medicina", "cerotto", "termometro", "aspirina", "pomata", "cotone"],
    zones: [
      // SINK - Face washing (face, eyes, nose, mouth, teeth, towel, soap, toothpaste)
      { id: 'sink', name: 'The Sink', nameNative: "Il Lavandino", description: 'Face, teeth, hands - washing area', icon: '🚰', x: 25, y: 45, width: 20, height: 25, interiorImage: '/rooms/bathroom-sink.jpg', interiorVocab: [{ wordId: 'sapone', x: 17, y: 25 }, { wordId: 'dentifricio', x: 50, y: 25 }, { wordId: 'spazzolino', x: 83, y: 25 }, { wordId: 'asciugamano', x: 17, y: 75 }, { wordId: 'specchio', x: 50, y: 75 }, { wordId: 'rubinetto', x: 83, y: 75 }] },
  ...
  },
  {
    ...
    vocabularyIds: ["fiore", "rosa", "erba", "albero", "foglia", "ramo", "radice", "sentiero", "ponte", "cancello", "pietra", "terra", "cielo", "sole", "luna", "stella", "nuvola"],
    zones: [
      { id: 'flowers', name: 'The Flowers', nameNative: "I Fiori", description: 'Nature and plants', icon: '🌸', x: 65, y: 60, width: 20, height: 20, interiorVocab: [{ wordId: 'fiore', x: 17, y: 17 }, { wordId: 'rosa', x: 50, y: 17 }, { wordId: 'erba', x: 83, y: 17 }, { wordId: 'albero', x: 17, y: 50 }, { wordId: 'foglia', x: 50, y: 50 }, { wordId: 'ramo', x: 83, y: 50 }, { wordId: 'radice', x: 17, y: 83 }] },
      { id: 'path', name: 'The Path', nameNative: "Il Vialetto", description: 'Places and directions', icon: '🛤️', x: 30, y: 75, width: 25, height: 15, interiorVocab: [{ wordId: 'sentiero', x: 17, y: 25 }, { wordId: 'ponte', x: 50, y: 25 }, { wordId: 'cancello', x: 83, y: 25 }, { wordId: 'pietra', x: 17, y: 75 }, { wordId: 'terra', x: 50, y: 75 }] },
      { id: 'sky', name: 'The Sky', nameNative: "Il Cielo", description: 'Weather and seasons', icon: '☀️', x: 50, y: 15, width: 30, height: 15, interiorVocab: [{ wordId: 'cielo', x: 17, y: 25 }, { wordId: 'sole', x: 50, y: 25 }, { wordId: 'luna', x: 83, y: 25 }, { wordId: 'stella', x: 17, y: 75 }, { wordId: 'nuvola', x: 50, y: 75 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    zones: [
      { id: 'ticket-office', name: 'Ticket Office', nameNative: "La Biglietteria", description: 'Buying tickets', icon: '🎫', x: 20, y: 45, width: 22, height: 25, interiorVocab: [{ wordId: 'biglietto', x: 17, y: 17 }, { wordId: 'orario', x: 50, y: 17 }, { wordId: 'valigia', x: 83, y: 17 }, { wordId: 'zaino', x: 17, y: 50 }, { wordId: 'abbonamento', x: 50, y: 50 }, { wordId: 'partenza', x: 83, y: 50 }, { wordId: 'arrivo', x: 17, y: 83 }] },
      { id: 'platform', name: 'Platform', nameNative: "Il Binario", description: 'Trains and departure', icon: '🚂', x: 50, y: 40, width: 25, height: 30, interiorVocab: [{ wordId: 'treno', x: 17, y: 25 }, { wordId: 'binario', x: 50, y: 25 }, { wordId: 'partenza', x: 83, y: 25 }, { wordId: 'arrivo', x: 17, y: 75 }, { wordId: 'ritardo', x: 50, y: 75 }, { wordId: 'vagone', x: 83, y: 75 }] },
      { id: 'street', name: 'Street Exit', nameNative: "L\'Uscita", description: 'Directions and navigation', icon: '🚶', x: 80, y: 50, width: 18, height: 25, interiorVocab: [{ wordId: 'uscita', x: 17, y: 17 }, { wordId: 'entrata', x: 50, y: 17 }, { wordId: 'semaforo', x: 83, y: 17 }, { wordId: 'incrocio', x: 17, y: 50 }, { wordId: 'direzione', x: 50, y: 50 }, { wordId: 'cartello', x: 83, y: 50 }, { wordId: 'strada', x: 17, y: 83 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    vocabularyIds: ["divano", "poltrona", "tavolino", "cuscino", "coperta", "televisione", "telecomando", "film", "musica", "schermo", "tavolo", "sedia", "lampada", "quadro", "tappeto", "tenda", "specchio", "libreria"],
    zones: [
      { id: 'sofa', name: 'The Sofa', nameNative: "Il Divano", description: 'Relaxation and free time', icon: '🛋️', x: 40, y: 60, width: 25, height: 20, interiorVocab: [{ wordId: 'divano', x: 17, y: 25 }, { wordId: 'poltrona', x: 50, y: 25 }, { wordId: 'tavolino', x: 83, y: 25 }, { wordId: 'cuscino', x: 17, y: 75 }, { wordId: 'coperta', x: 50, y: 75 }] },
      { id: 'tv', name: 'The TV', nameNative: "La TV", description: 'Entertainment and media', icon: '📺', x: 70, y: 45, width: 15, height: 15, interiorVocab: [{ wordId: 'televisione', x: 17, y: 25 }, { wordId: 'telecomando', x: 50, y: 25 }, { wordId: 'film', x: 83, y: 25 }, { wordId: 'musica', x: 17, y: 75 }, { wordId: 'schermo', x: 50, y: 75 }] },
      { id: 'furniture', name: 'Furniture', nameNative: "I Mobili", description: 'Home items', icon: '🏠', x: 20, y: 45, width: 15, height: 20, interiorVocab: [{ wordId: 'tavolo', x: 17, y: 17 }, { wordId: 'sedia', x: 50, y: 17 }, { wordId: 'lampada', x: 83, y: 17 }, { wordId: 'quadro', x: 17, y: 50 }, { wordId: 'tappeto', x: 50, y: 50 }, { wordId: 'tenda', x: 83, y: 50 }, { wordId: 'specchio', x: 17, y: 83 }, { wordId: 'libreria', x: 50, y: 83 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    zones: [
      { id: 'produce', name: 'Fresh Produce', nameNative: "Frutta e Verdura", description: 'Fruits and vegetables', icon: '🍎', x: 20, y: 50, width: 25, height: 30, interiorVocab: [{ wordId: 'mela', x: 13, y: 17 }, { wordId: 'pera', x: 38, y: 17 }, { wordId: 'arancia', x: 63, y: 17 }, { wordId: 'banana', x: 88, y: 17 }, { wordId: 'carota', x: 13, y: 50 }, { wordId: 'lattuga', x: 38, y: 50 }, { wordId: 'pomodoro', x: 63, y: 50 }, { wordId: 'uva', x: 88, y: 50 }, { wordId: 'fragola', x: 13, y: 83 }, { wordId: 'pesca', x: 38, y: 83 }] },
      { id: 'dairy', name: 'Dairy Section', nameNative: "Latticini", description: 'Milk and cheese', icon: '🧀', x: 50, y: 45, width: 20, height: 25 },
      { id: 'checkout', name: 'Checkout', nameNative: "La Cassa", description: 'Paying and prices', icon: '💰', x: 80, y: 55, width: 18, height: 20, interiorVocab: [{ wordId: 'cassa', x: 17, y: 17 }, { wordId: 'carrello', x: 50, y: 17 }, { wordId: 'scontrino', x: 83, y: 17 }, { wordId: 'contanti', x: 17, y: 50 }, { wordId: 'carta', x: 50, y: 50 }, { wordId: 'prezzo', x: 83, y: 50 }, { wordId: 'euro', x: 17, y: 83 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    zones: [
      { id: 'counter', name: 'The Counter', nameNative: "Il Bancone", description: 'Ordering coffee', icon: '☕', x: 35, y: 40, width: 30, height: 20, interiorVocab: [{ wordId: 'caffe', x: 17, y: 25 }, { wordId: 'cornetto', x: 50, y: 25 }, { wordId: 'tazza', x: 83, y: 25 }, { wordId: 'menu', x: 17, y: 75 }, { wordId: 'barista', x: 50, y: 75 }] },
      { id: 'table-cafe', name: 'Table', nameNative: "Il Tavolo", description: 'Sitting and socializing', icon: '🪑', x: 70, y: 60, width: 25, height: 20, interiorVocab: [{ wordId: 'tavolo', x: 17, y: 17 }, { wordId: 'sedia', x: 50, y: 17 }, { wordId: 'menu', x: 83, y: 17 }, { wordId: 'conto', x: 17, y: 50 }, { wordId: 'bicchiere', x: 50, y: 50 }, { wordId: 'piatto', x: 83, y: 50 }, { wordId: 'tovagliolo', x: 17, y: 83 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    vocabularyIds: ["clima", "grado", "nebbia", "temporale", "tuono", "aria", "cenere", "energia", "inquinamento", "onda", "sole", "nuvola", "vento", "arcobaleno", "fulmine", "pioggia"],
    zones: [
      ...
      { id: 'sky-weather', name: 'Sky View', nameNative: "Il Cielo", description: 'Clouds, sun, fog', icon: '🌤️', x: 55, y: 30, width: 30, height: 20, interiorVocab: [{ wordId: 'sole', x: 17, y: 25 }, { wordId: 'nuvola', x: 50, y: 25 }, { wordId: 'vento', x: 83, y: 25 }, { wordId: 'arcobaleno', x: 17, y: 75 }, { wordId: 'fulmine', x: 50, y: 75 }, { wordId: 'pioggia', x: 83, y: 75 }] },
    ],
    grammarPoints: [
