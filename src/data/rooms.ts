...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    zones: [
      ...
      { id: 'wardrobe', name: 'The Wardrobe', nameNative: "L\'Armadio", description: 'Clothes hanging - shirts, pants, dresses, coats', icon: '👔', x: 70, y: 40, width: 15, height: 30, interiorImage: '/rooms/bedroom-wardrobe.jpg', interiorVocab: [{ wordId: 'camicia', x: 12, y: 15 }, { wordId: 'camicetta', x: 25, y: 15 }, { wordId: 'maglietta', x: 38, y: 15 }, { wordId: 'maglione', x: 51, y: 15 }, { wordId: 'giacca', x: 64, y: 15 }, { wordId: 'cappotto', x: 77, y: 15 }, { wordId: 'impermeabile', x: 88, y: 15 }, { wordId: 'vestito', x: 12, y: 45 }, { wordId: 'gonna', x: 25, y: 45 }, { wordId: 'pantaloni', x: 38, y: 45 }, { wordId: 'jeans', x: 51, y: 45 }, { wordId: 'pigiama', x: 64, y: 45 }] },
      // DRAWER - Accessories (socks, ties, belts, scarves, gloves, beanies)
      { id: 'drawer', name: 'Accessory Drawer', nameNative: "Il Cassetto", description: 'Socks, ties, belts, scarves, gloves', icon: '🧦', x: 85, y: 60, width: 12, height: 15, interiorImage: '/rooms/bedroom-drawer.jpg', interiorVocab: [{ wordId: 'calze', x: 20, y: 25 }, { wordId: 'cravatta', x: 50, y: 25 }, { wordId: 'cintura', x: 80, y: 25 }, { wordId: 'sciarpa', x: 20, y: 55 }, { wordId: 'guanti', x: 50, y: 55 }, { wordId: 'berretto', x: 80, y: 55 }] },
      // JEWELRY - Jewelry box (rings, necklaces, earrings, watches)
      { id: 'jewelry', name: 'Jewelry Box', nameNative: "Il Portagioie", description: 'Rings, necklaces, earrings, watches', icon: '💍', x: 20, y: 55, width: 12, height: 12, interiorImage: '/rooms/bedroom-jewelry.jpg', interiorVocab: [{ wordId: 'anello', x: 20, y: 25 }, { wordId: 'collana', x: 50, y: 25 }, { wordId: 'orecchino', x: 80, y: 25 }, { wordId: 'orologio', x: 50, y: 60 }] },
      // SHOES - Shoe rack (shoes, boots, slippers)
      { id: 'shoes', name: 'Shoe Rack', nameNative: "La Scarpiera", description: 'Shoes, boots, slippers', icon: '👟', x: 15, y: 75, width: 20, height: 12, interiorImage: '/rooms/bedroom-shoes.jpg', interiorVocab: [{ wordId: 'scarpe', x: 15, y: 35 }, { wordId: 'stivali', x: 40, y: 35 }, { wordId: 'pantofole', x: 65, y: 35 }] },
      // BED - Bedding (pillows, blankets, sheets)
      { id: 'bed', name: 'The Bed', nameNative: "Il Letto", description: 'Pillows, blankets, sheets', icon: '🛏️', x: 40, y: 55, width: 25, height: 20, interiorImage: '/rooms/bedroom-bed.jpg', interiorVocab: [{ wordId: 'letto', x: 20, y: 30 }, { wordId: 'cuscino', x: 50, y: 30 }, { wordId: 'coperta', x: 80, y: 30 }, { wordId: 'lenzuolo', x: 35, y: 60 }] },
      // NIGHTSTAND - Bedside items (lamp, alarm clock, book, glasses)
      { id: 'nightstand', name: 'Nightstand', nameNative: "Il Comodino", description: 'Lamp, alarm clock, book, glasses', icon: '🌙', x: 70, y: 70, width: 10, height: 12, interiorImage: '/rooms/bedroom-nightstand.jpg', interiorVocab: [{ wordId: 'comodino', x: 20, y: 30 }, { wordId: 'lampada', x: 50, y: 30 }, { wordId: 'sveglia', x: 80, y: 30 }, { wordId: 'libro', x: 35, y: 65 }, { wordId: 'occhiali', x: 65, y: 65 }] },
    ],
    grammarPoints: [
  ...
  },
  {
    ...
    zones: [
      ...
      { id: 'sink', name: 'The Sink', nameNative: "Il Lavandino", description: 'Face, teeth, hands - washing area', icon: '🚰', x: 25, y: 45, width: 20, height: 25, interiorImage: '/rooms/bathroom-sink.jpg', interiorVocab: [{ wordId: 'faccia', x: 30, y: 20 }, { wordId: 'occhi', x: 50, y: 20 }, { wordId: 'naso', x: 70, y: 20 }, { wordId: 'bocca', x: 30, y: 45 }, { wordId: 'denti', x: 50, y: 45 }, { wordId: 'lavandino', x: 70, y: 45 }, { wordId: 'sapone', x: 20, y: 70 }, { wordId: 'dentifricio', x: 50, y: 70 }, { wordId: 'asciugamano', x: 80, y: 70 }] },
      // SHOWER - Body washing (body, head, hair, arms, hands, legs, shower, shampoo)
      { id: 'shower', name: 'The Shower', nameNative: "La Doccia", description: 'Body, hair - shower area', icon: '🚿', x: 60, y: 35, width: 25, height: 35, interiorImage: '/rooms/bathroom-shower.jpg', interiorVocab: [{ wordId: 'corpo', x: 25, y: 25 }, { wordId: 'testa', x: 50, y: 25 }, { wordId: 'capelli', x: 75, y: 25 }, { wordId: 'braccio', x: 25, y: 50 }, { wordId: 'mano', x: 50, y: 50 }, { wordId: 'gamba', x: 75, y: 50 }, { wordId: 'doccia', x: 25, y: 75 }, { wordId: 'shampoo', x: 50, y: 75 }, { wordId: 'bagno', x: 75, y: 75 }] },
      // MEDICINE - Health items (medicine, band-aid, thermometer)
      { id: 'cabinet', name: 'Medicine Cabinet', nameNative: "L\'Armadietto", description: 'Medicine, first aid, health items', icon: '💊', x: 85, y: 30, width: 12, height: 20, interiorImage: '/rooms/bathroom-medicine.jpg', interiorVocab: [{ wordId: 'medicina', x: 25, y: 25 }, { wordId: 'cerotto', x: 50, y: 25 }, { wordId: 'termometro', x: 75, y: 25 }] },
    ],
    grammarPoints: [
