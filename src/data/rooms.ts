...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    vocabularyIds: ["acqua", "latte", "uova", "burro", "formaggio", "carne", "pesce", "pollo", "yogurt", "panna", "pasta", "riso", "pane", "farina", "zucchero", "caffe", "olio", "sale", "coltello", "forchetta", "cucchiaio", "mestolo", "spatola", "grattugia", "padella", "pentola", "tagliere", "forno", "fornello", "colino", "piatto", "bicchiere", "tazza", "tovagliolo", "vino", "birra", "succo", "torta", "gelato", "cornetto", "cioccolata", "miele", "biscotto"],
    zones: [
      // FRIDGE - Cold items (water, milk, eggs, cheese, meat, fish, chicken, vegetables, fruits)
      { id: 'fridge', name: 'The Fridge', nameNative: "Il Frigorifero", description: 'Cold food and drinks - dairy, meat, vegetables, fruits', icon: '❄️', x: 75, y: 45, width: 15, height: 25, interiorImage: '/rooms/kitchen-fridge.jpg', interiorVocab: [{ wordId: 'acqua', x: 13, y: 17 }, { wordId: 'latte', x: 38, y: 17 }, { wordId: 'uova', x: 63, y: 17 }, { wordId: 'burro', x: 88, y: 17 }, { wordId: 'formaggio', x: 13, y: 50 }, { wordId: 'carne', x: 38, y: 50 }, { wordId: 'pesce', x: 63, y: 50 }, { wordId: 'pollo', x: 88, y: 50 }, { wordId: 'yogurt', x: 13, y: 83 }, { wordId: 'panna', x: 38, y: 83 }] },
      // PANTRY - Dry goods (pasta, rice, bread, flour, sugar, coffee, oil, preserves)
      { id: 'pantry', name: 'The Pantry', nameNative: "La Dispensa", description: 'Dry goods and staples - pasta, rice, canned goods', icon: '🥫', x: 88, y: 40, width: 10, height: 30, interiorImage: '/rooms/kitchen-pantry.jpg', interiorVocab: [{ wordId: 'pasta', x: 17, y: 17 }, { wordId: 'riso', x: 50, y: 17 }, { wordId: 'pane', x: 83, y: 17 }, { wordId: 'farina', x: 17, y: 50 }, { wordId: 'zucchero', x: 50, y: 50 }, { wordId: 'caffe', x: 83, y: 50 }, { wordId: 'olio', x: 17, y: 83 }, { wordId: 'sale', x: 50, y: 83 }] },
      ...
      { id: 'stove', name: 'The Stove', nameNative: "I Fornelli", description: 'Cooking and preparation - pots, pans, oven', icon: '🔥', x: 60, y: 55, width: 15, height: 15, interiorImage: '/rooms/kitchen-stove.jpg', interiorVocab: [{ wordId: 'padella', x: 17, y: 25 }, { wordId: 'pentola', x: 50, y: 25 }, { wordId: 'tagliere', x: 83, y: 25 }, { wordId: 'forno', x: 17, y: 75 }, { wordId: 'fornello', x: 50, y: 75 }, { wordId: 'colino', x: 83, y: 75 }] },
  ...
  },
  {
    ...
    zones: [
      { id: 'storms', name: 'Storm Center', nameNative: "Temporali", description: 'Thunder, lightning, hail', icon: '⛈️', x: 25, y: 35, width: 25, height: 25, interiorVocab: [{ wordId: 'temporale', x: 17, y: 25 }, { wordId: 'tuono', x: 50, y: 25 }, { wordId: 'fulmine', x: 83, y: 25 }, { wordId: 'nebbia', x: 17, y: 75 }, { wordId: 'grandine', x: 50, y: 75 }, { wordId: 'pioggia', x: 83, y: 75 }] },
