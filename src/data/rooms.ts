...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    zones: [
      ...
      { id: 'desk', name: 'Study Desk', nameNative: "La Scrivania", description: 'Study and work', icon: '📝', x: 60, y: 60, width: 20, height: 20, interiorImage: '/rooms/library-desk.jpg', interiorVocab: [{ wordId: 'quaderno', x: 13, y: 17 }, { wordId: 'penna', x: 38, y: 17 }, { wordId: 'matita', x: 63, y: 17 }, { wordId: 'gomma', x: 88, y: 17 }, { wordId: 'righello', x: 13, y: 50 }, { wordId: 'calendario', x: 38, y: 50 }, { wordId: 'carta', x: 63, y: 50 }, { wordId: 'scrivania', x: 88, y: 50 }, { wordId: 'lezione', x: 13, y: 83 }, { wordId: 'pagina', x: 38, y: 83 }] },
  ...
  },
  {
    ...
    zones: [
      { id: 'flowers', name: 'The Flowers', nameNative: "I Fiori", description: 'Nature and plants', icon: '🌸', x: 65, y: 60, width: 20, height: 20, interiorImage: '/rooms/garden-flowers.jpg', interiorVocab: [{ wordId: 'fiore', x: 17, y: 17 }, { wordId: 'rosa', x: 50, y: 17 }, { wordId: 'erba', x: 83, y: 17 }, { wordId: 'albero', x: 17, y: 50 }, { wordId: 'foglia', x: 50, y: 50 }, { wordId: 'ramo', x: 83, y: 50 }, { wordId: 'radice', x: 17, y: 83 }] },
  ...
  },
  {
    ...
    zones: [
      ...
      { id: 'tv', name: 'The TV', nameNative: "La TV", description: 'Entertainment and media', icon: '📺', x: 70, y: 45, width: 15, height: 15, interiorImage: '/rooms/livingroom-tv.jpg', interiorVocab: [{ wordId: 'televisione', x: 17, y: 25 }, { wordId: 'telecomando', x: 50, y: 25 }, { wordId: 'film', x: 83, y: 25 }, { wordId: 'musica', x: 17, y: 75 }, { wordId: 'schermo', x: 50, y: 75 }] },
  ...
  },
  {
    ...
    zones: [
      { id: 'produce', name: 'Fresh Produce', nameNative: "Frutta e Verdura", description: 'Fruits and vegetables', icon: '🍎', x: 20, y: 50, width: 25, height: 30, interiorImage: '/rooms/supermarket-produce.jpg', interiorVocab: [{ wordId: 'mela', x: 13, y: 17 }, { wordId: 'pera', x: 38, y: 17 }, { wordId: 'arancia', x: 63, y: 17 }, { wordId: 'banana', x: 88, y: 17 }, { wordId: 'carota', x: 13, y: 50 }, { wordId: 'lattuga', x: 38, y: 50 }, { wordId: 'pomodoro', x: 63, y: 50 }, { wordId: 'uva', x: 88, y: 50 }, { wordId: 'fragola', x: 13, y: 83 }, { wordId: 'pesca', x: 38, y: 83 }] },
